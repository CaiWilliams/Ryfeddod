...
plt.text(1.7,265, 'CFPV', c='white',fontsize=FontSize)
...
plt.annotate('Conventional', xy=(1.2,265),xycoords='data', xytext=(1.3,220),textcoords='data',arrowprops=dict(arrowstyle="->",connectionstyle="angle,angleA=0,angleB=90,rad=10",color="white"),c='white',fontsize=FontSize)

plt.annotate('Wind Onshore', xy=(1,190),xycoords='data', xytext=(1.1,75),textcoords='data',arrowprops=dict(arrowstyle="->",connectionstyle="angle,angleA=0,angleB=90,rad=10",color="white"),c='white',fontsize=FontSize)
plt.annotate('Wind Offshore', xy=(0.95,170),xycoords='data', xytext=(1.1,65),textcoords='data',arrowprops=dict(arrowstyle="->",connectionstyle="angle,angleA=0,angleB=90,rad=10",color="white"),c='white',fontsize=FontSize)
...
plt.annotate('Hydro', xy=(0.85,160),xycoords='data', xytext=(1.1,55),textcoords='data',arrowprops=dict(arrowstyle="->",connectionstyle="angle,angleA=0,angleB=90,rad=10",color="white"),c='white',fontsize=FontSize)
...
plt.tight_layout()
plt.savefig('S2c.svg',transparent=True)
plt.savefig('S2c.png',transparent=True)
#plt.show()